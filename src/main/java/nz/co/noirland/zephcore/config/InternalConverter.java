...
import nz.co.noirland.zephcore.config.converter.*;
...
public class InternalConverter {
    private LinkedHashSet<Converter> converters = new LinkedHashSet<Converter>();

    public InternalConverter() {
        try {
            addConverter(Array.class);
            addConverter(Block.class);
            addConverter(nz.co.noirland.zephcore.config.converter.Config.class);
            addConverter(ItemStack.class);
            addConverter(List.class);
            addConverter(Location.class);
